...
public class SecurityAndSafetyManagersInDistrict {
    ...
    public void ADDSecurityAndSafetyManagersInDistrict() throws InterruptedException {
        ...
        waitQA.until(ExpectedConditions.visibilityOfElementLocated(MyInputLocator)).sendKeys("السلامة");
        ...
        waitQA.until(ExpectedConditions.visibilityOfElementLocated(GebderDDLLSearchocator)).sendKeys("بنات" , Keys.ENTER);
